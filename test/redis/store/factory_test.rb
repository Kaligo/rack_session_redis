...
describe 'Redis::Store::Factory' do
  describe '.create' do
    ...
    describe 'when given a Hash' do
      ...
      it 'does not work with more than one address' do
    ...
    describe 'when given a String' do
      ...
      it 'does not work with more than one address' do
        assert_raises RuntimeError do
          Redis::Store::Factory.create 'redis://127.0.0.1:6379', 'redis://127.0.0.1:6380'
        end
      end
    end
    ...
    describe 'when given host String and options Hash' do
      ...
      it 'does not work with more than one address' do
        assert_raises RuntimeError do
          Redis::Store::Factory.create 'redis://127.0.0.1:6379', 'redis://127.0.0.1:6380', namespace: 'theplaylist'
        end
      end
